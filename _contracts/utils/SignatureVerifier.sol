...
import { 
    // Choice,          //@Choice
    IndexedStrategy, Strategy } from "contracts/types.sol";
...
abstract contract SignatureVerifier is EIP712 {
    ...
    function _verifyVoteSig(uint8 v, bytes32 r, bytes32 s, address space, bytes calldata data) internal view {      // @Choice      // tbd
        (
            address voter,
            uint256 proposeId,
            bytes memory choice,
